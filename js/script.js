...
const members = {
    ...
    serviceBill     :20,
    othersBill      :0,
    runningMonth    :"November-24",
    previousMonth   :"October-24", // new addDecember
    upComingMonth   :"December 1,2024",
    runningMealRate :60,
    ...
    "01814843266":{
        ...
        payment             :{"03/11/24-Cash":4300},
        // running month {"01/07/24-Cash":500}
        stay_cost       :2200,
        garage_cost     :0,
        running_payable :2366,
        running_paid    :4300,
        running_meal    :28,
        // method calling
        preMonth,
    ...
    "01922362569":{
        ...
        previous_paid       :4000,
        previous_dining_cost:1350,
        payment             :{"10/11/24-DBBL":2000,"19/11/24-DBBL":500,"25/11/24-DBBL":500,"29/11/24-DBBL":500,"30/11/24-Cash":400},
        // running month
        stay_cost       :2000,
        garage_cost     :0,
        running_payable :2616,
        running_paid    :3900,
        running_meal    :25,
        // method calling
        preMonth,
    ...
    "01744459622":{
        ...
        post_payable        :3150,
        previous_paid       :5500,
        previous_dining_cost:2538,
        payment             :{"09/11/24-Cash":5000,"10/11/24-Cash":1000},
        // running month
        stay_cost       :2700,
        garage_cost     :200,
        running_payable :3748,
        running_paid    :6000,
        running_meal    :38,
        // method calling
        preMonth,
    ...
    "01780608997":{
        ...
        previous_paid       :5000,
        previous_dining_cost:1350,
        payment             :{"17/11/24-Cash":6000,"27/11/24-Nagad":1000},
        // running month
        stay_cost       :3500,
        garage_cost     :0,
        running_payable :5044,
        running_paid    :7000,
        running_meal    :28,
        // method calling
        preMonth,
    ...
    "01644377150":{
        ...
        post_payable        :3800,
        previous_paid       :5500,
        previous_dining_cost:2900,
        payment             :{"02/11/24-bKash":3000,"14/11/24-bKash":2000,"26/11/24-bKash":500},
        // running month
        stay_cost       :2400,
        garage_cost     :0,
        running_payable :4260,
        running_paid    :5500,
        running_meal    :38,
        // method calling
        preMonth,
    ...
    "01645122114":{
        ...
        post_payable        :4435,
        previous_paid       :5000,
        previous_dining_cost:1836,
        payment             :{"01/11/24-bKash":1000,"08/11/24-bKash":5000},
        // running month
        stay_cost       :3000,
        garage_cost     :0,
        running_payable :4931,
        running_paid    :6000,
        running_meal    :54,
        // method calling
        preMonth,
    ...
    "01714443406":{
        ...
        post_payable        :5531,
        previous_paid       :6000,
        previous_dining_cost:1566,
        payment             :{"01/11/24-bKash":2000,"04/11/24-Cash":1000,"21/11/24-Cash":2000,"30/11/24-Cash":1000},
        // running month
        stay_cost       :3000,
        garage_cost     :0,
        running_payable :4757,
        running_paid    :6000,
        running_meal    :36,
        // method calling
        preMonth,
    ...
    "01834648400":{
        ...
        post_payable        :2166,
        previous_paid       :2000,
        previous_dining_cost:648,
        payment             :{"13/11/24-Cash":2000,"27/11/24-Cash":2000},
        // running month
        stay_cost       :2500,
        garage_cost     :0,
        running_payable :3314,
        running_paid    :4000,
        running_meal    :28,
        // method calling
        preMonth,
    ...
    "01749244430":{
        ...
        post_payable        :4585,
        previous_paid       :6000,
        previous_dining_cost:1890,
        payment             :{"07/11/24-Cash":5500,"27/11/24-Cash":1000},
        // running month
        stay_cost       :3500,
        garage_cost     :0,
        running_payable :4635,
        running_paid    :6500,
        running_meal    :32,
        // method calling
        preMonth,
